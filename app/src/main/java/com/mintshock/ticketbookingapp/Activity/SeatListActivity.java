...
import com.mintshock.ticketbookingapp.Adapter.SeatAdapter;
import com.mintshock.ticketbookingapp.Model.Flight;
import com.mintshock.ticketbookingapp.Model.Seat;
import com.mintshock.ticketbookingapp.R;
import com.mintshock.ticketbookingapp.databinding.ActivitySeatListBinding;
...
public class SeatListActivity extends BaseActivity {
    ...
    private void initSeatList() {
        ...
        SeatAdapter seatAdapter = new SeatAdapter(seatList, this, (selectedName, num) -> {
            binding.numberSelectedText.setText(num + " Seat Selected");
