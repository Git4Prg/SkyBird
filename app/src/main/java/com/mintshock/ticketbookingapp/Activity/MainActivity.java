...
import com.mintshock.ticketbookingapp.Model.Location;
import com.mintshock.ticketbookingapp.R;
import com.mintshock.ticketbookingapp.databinding.ActivityMainBinding;
...
public class MainActivity extends BaseActivity {
    ...
    private void initDatePickup() {
        ...
        binding.returnDateText.setText(tomorrowDate);

        binding.departureDateText.setOnClickListener(v -> showDatePickerDialog(binding.departureDateText));
        binding.returnDateText.setOnClickListener(v -> showDatePickerDialog(binding.returnDateText));
    }
    ...
    private void initPassengers() {
        binding.plusAdultBtn.setOnClickListener(v -> {
            adultPassenger++;
            binding.AdultText.setText(adultPassenger+ " Adult");
        });
        ...
        binding.plusChildBtn.setOnClickListener(v -> {
            childPassenger++;
            binding.ChildText.setText(childPassenger + " Child");
        });
